...
>
  <form>
    ...
    <div class="mx-2 mb-2 flex gap-2 w-full justify-center">
      ...
      <button formmethod="dialog" class="p-1" value="export-and-delete"
        >Export and Delete</button
      >
...
>
  ...
  <hr
    style="border-top: 1px solid dimgrey !important; width:100%"
    class="m-1"
  />
  <div class="italic">
    {intlFormatDistance(piece.updated, Date.now())} - {Math.round(
      (Object.keys(piece.data).length * 11.2) / 1024,
    )} kb<!-- complete guess because i couldn't figure this out -->
  </div>
</button>
